...
public class APreprocessor {
	 ...
	 * */
	@SuppressWarnings("resource")
	public List<AOccurrence> spiltedSentences(String pathname, List<Seed> seeds) {
		// String pathname="D:/PPPPPPPractice/ckxx_jieba_seg.txt";
		File file = new File(pathname);
		BufferedInputStream fis;

		AOccurrence aoccurrence = new AOccurrence();
		List<AOccurrence> listAOccurrence = new ArrayList<>();
							...
							for (int flag = 0; flag < seeds.size(); flag++) {
								...
								if (sentences.get(pos).equals(seeds.get(flag).getSeedfirst()) == true) {
									...
									if (ordera && orderb) {
										...
										for (int a = posb + 1; a < sentences.size(); a++) {
										...
										aoccurrence = new AOccurrence(prefix,seedf, middle, seedl, suffix,symbol,order, num);
										listAOccurrence.add(aoccurrence);
										//System.out.println(aoccurrence.toString());
										//System.out.println();
		...
		//System.out.println();
//		System.out.println("\n************listAOccurence***************");
//		for(AOccurrence str:listAOccurrence){
//			System.out.println(str);
//		}
//		System.out.println("************listAOccurence***************\n");


		return listAOccurrence;
	}



	public  void findOccurrence(List<AOccurrence> aoccurrence,List<Seed> seed) {
		...
		for(AOccurrence str: aoccurrence){
